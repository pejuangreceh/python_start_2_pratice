...
btn_OK = QPushButton('Next Question')
...
lb_Result = QLabel('Correct') # “Correct” or “Incorrect” text will be here
lb_Correct = QLabel('Option 1') # correct answer text will be written here 
...
btn_OK.clicked.connect(tamplikan_pertanyaan)
